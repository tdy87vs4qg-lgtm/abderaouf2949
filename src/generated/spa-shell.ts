    ...
    <script>
      ...
      (function () {
        try {
          ...
          if (m) m.setAttribute('content', t === 'light' ? '#faf7ed' : '#171511');
        } catch (e) {
          document.documentElement.setAttribute('data-theme', 'dark');
        }
      })();
    </script>
    <script type="module" crossorigin src="/react/assets/index-DWgcQUGA.js"></script>
    <link rel="modulepreload" crossorigin href="/react/assets/rolldown-runtime-CNC7AqOf.js">
    <link rel="modulepreload" crossorigin href="/react/assets/react-vendor-CyA734zk.js">
    <link rel="modulepreload" crossorigin href="/react/assets/icons-DFwQVwPe.js">
    <link rel="stylesheet" crossorigin href="/react/assets/index-CrlFwExJ.css">
    ...
    <div id="root">
      ...
      <style>
        ...
        .app-boot__spinner{width:22px;height:22px;border-radius:50%;
          border:1.5px solid rgba(124,201,140,.18);border-top-color:#7cc98c;
